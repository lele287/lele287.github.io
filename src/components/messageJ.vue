<template>
  <div class="nous">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="常识" name="first">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8530.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="饮食" name="second">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8530.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="运动" name="third">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8530.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="医学减肥" name="fourth">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8530.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
...
export default {
  ...
  beforeMount() {
    this.$axios
      .get("/api/nousRouter/getNous", { params: { key: "常识" } })
      .then(res => {
        // console.log("res:", res);
        // this.news = res.data.data
