<template>
  <div class="nous">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="护肤" name="first">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8526.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="化妆" name="second">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8526.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="整型" name="third">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8526.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="美容食谱" name="fourth">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8526.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
...
export default {
  ...
  beforeMount() {
    this.$axios
      .get("/api/nousRouter/getNous", { params: { key: "护肤" } })
      .then(res => {
        // console.log("res:", res);
        // this.news = res.data.data
