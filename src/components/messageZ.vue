<template>
  <div class="nous">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="内科" name="first">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8520.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="外科" name="second">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8520.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="皮肤科" name="third">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8520.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
      ...
      <el-tab-pane label="五官科" name="four">
        <div class="message">
          <img src="https://img95.699pic.com/photo/40180/8520.jpg_wh300.jpg" class="imgs" />
          <div class="content">
            <ul>
...
export default {
  ...
  beforeMount() {
    this.$axios
      .get("/api/nousRouter/getNous", { params: { key: "内科" } })
      .then(res => {
        // console.log("res:", res);
        // this.news = res.data.data
